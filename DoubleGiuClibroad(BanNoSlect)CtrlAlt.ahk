...
;GroupAdd, DontActiveGroup, ahk_class Qt5QWindowIcon ; Disable tren Goldendict ban x64
;GroupAdd, DontActiveGroup, ahk_class Qt630QWindowIcon ; Disable tren Goldendict
;GroupAdd, DontActiveGroup, ahk_class QWidget ; Disable tren Goldendict
GroupAdd, DontActiveGroup, ahk_class SysListView32
GroupAdd, DontActiveGroup, ahk_class DirectUIHWND
GroupAdd, DontActiveGroup, ahk_class SysTreeView32
...
#IfWinNotActive ahk_group DontActiveGroup
~^LButton::        ;Them ~ de khong chan chuc nang goc Ctrl
TimeButtonDown = %A_TickCount%
...
#IfWinNotActive ahk_group DontActiveGroup
~!LButton::        ;Them ~ de khong chan chuc nang goc Alt
TimeButtonDown = %A_TickCount%
MouseGetPos x0, y0            ; save start mouse position
; Wait for it to be released
Loop
